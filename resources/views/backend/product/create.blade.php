...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
          <label for="size">Loại Aacc</label>
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              <option value="">--Chọn loại--</option>
              <option value="EP">E.Point</option>
              <option value="NOEP">Acc Mỹ</option>
        ...
        <div class="form-group">
          <label for="condition">Loại</label>
        ...
        <div class="form-group" hidden>
          ...
          <input id="quantity" type="number" name="stock" min="0" placeholder="Enter quantity"  value="1" class="form-control">
          @error('stock')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
