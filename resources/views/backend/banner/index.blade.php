...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('banner.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Thêm Bìa</a>
    </div>
    <div class="card-body">
          ...
          <tbody>
            @foreach($banners as $banner)   
                <tr>
                    ...
                    <td>
                        <a href="{{route('banner.edit',$banner->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="Sửa" data-placement="bottom"><i class="fas fa-edit"></i></a>
        ...
        $.ajaxSetup({
          ...
          $('.dltBtn').click(function(e){
            var form=$(this).closest('form');
              ...
              swal({
                    title: "Bạn có muốn ?",
                    text: "Xóa dữ liệu và không thể hoàn tác !",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
