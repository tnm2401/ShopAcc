    ...
    <div class="card-body">
      <form method="post" action="{{route('banner.update',$banner->id)}}">
        ...
        <div class="form-group">
          <label for="inputTitle" class="col-form-label">Nội Dung <span class="text-danger">*</span></label>
        <input id="inputTitle" type="text" name="title" placeholder="Nhập nội dung"  value="{{$banner->title}}" class="form-control">
        @error('title')
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            ...
            <option value="inactive" {{(($banner->status=='inactive') ? 'selected' : '')}}>Vô Hiệu Hóa</option>
          </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
